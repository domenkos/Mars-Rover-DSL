...
public class MarsRoverGenerator extends AbstractGenerator {
  ...
  public CharSequence toCpp(final Robot root) {
    ...
    _builder.newLine();
    {
      if ((this.dr != null)) {
        _builder.append("\t\t");
        _builder.append("const int NUMBER_OF_ROCKS = ");
        int _number_of_rocks = this.dr.getNumber_of_rocks();
        _builder.append(_number_of_rocks, "\t\t");
        _builder.append(";");
        _builder.newLineIfNotEmpty();
      } else {
        _builder.append("\t\t");
        _builder.append("const int NUMBER_OF_ROCKS = 3;");
        _builder.newLine();
      }
    }
    _builder.append("\t\t");
    _builder.append("const int ULTRASONIC_FRONT_DISTANCE_ROCKS = 12;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.newLine();
    {
      if ((this.dl != null)) {
        ...
        _builder.append("\t\t");
        _builder.append("const int NUM_OF_LAKES = 3;");
        _builder.newLine();
      }
    }
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("ter_tsk(STAY_TASK);");
    _builder.newLine();
    _builder.append("\t\t    ");
    _builder.append("ter_tsk(BT_TASK);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("case 0: ev3_led_set_color(LED_OFF); break;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("case 1: turn(true, SPECIAL_SPEED); ev3_led_set_color(LED_ORANGE); break;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("case 2: turn(false, SPECIAL_SPEED); ev3_led_set_color(LED_RED); break;");
    _builder.newLine();
    _builder.append("\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("return (color_left + color_mid + color_right + (ultrasonic_front - 1) * 2) % 2 == 0;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t");
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("ev3_motor_set_power(SMALL_ARM, -8);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("dly_tsk(1500);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("ev3_motor_stop(SMALL_ARM,true);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("dly_tsk(1200);");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("ev3_motor_set_power(SMALL_ARM, 8);");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if (ultrasonic_front < 12 && ultrasonic_front != 0) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("int i = 0;");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("ev3_motor_set_power(SMALL_ARM, -10);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("dly_tsk(200);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("ev3_motor_stop(SMALL_ARM,true);");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("ev3_speaker_play_tone(100,1000);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("} while(color_left != COLOR_WHITE && color_right != COLOR_WHITE && color_mid != COLOR_WHITE &&");
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("!color_found_avoid(color_mid)");
    _builder.newLine();
    _builder.append("\t\t\t  ");
    _builder.append(");");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("void after_examinating_all_rocks()");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("{");
    _builder.newLine();
    {
      boolean _notEquals_4 = (!Objects.equal(this.dr, null));
      if (_notEquals_4) {
        _builder.append("\t\t");
        String _indicationRocks = this.getIndicationRocks();
        _builder.append(_indicationRocks, "\t\t");
        _builder.newLineIfNotEmpty();
        {
          String _action_1 = this.dr.getAfter_examinating().getAction();
          boolean _equals_1 = Objects.equal(_action_1, "stop");
          if (_equals_1) {
            _builder.append("\t\t");
            _builder.append("do_exit = true;");
            _builder.newLine();
    ...
    _builder.append("\t\t");
    _builder.append("examined_rocks++;");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("void detect_rocks()");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("if(ultrasonic_front < ULTRASONIC_FRONT_DISTANCE_ROCKS && ultrasonic_front != 0)");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if(examined_rocks < NUMBER_OF_ROCKS)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("moving(0,0);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("ev3_motor_set_power(SMALL_ARM, -5);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("dly_tsk(800);");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("ev3_motor_stop(SMALL_ARM,true);");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("turn(random_turn_direction(), DRIVE_SPEED*1.5);");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("after_examinating_all_rocks();");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("else if(examined_rocks > NUMBER_OF_ROCKS)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{");
    _builder.newLine();
    {
      String _action_2 = this.dr.getAfter_examinating().getAction();
      boolean _equals_2 = Objects.equal(_action_2, "continue");
      if (_equals_2) {
        _builder.append("\t\t\t\t");
        _builder.append("avoid_obstacles(); //v primru continue");
        _builder.newLine();
      }
    }
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t");
    _builder.append("void park()");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("{");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("bool_t parked = false;");
    _builder.newLine();
    _builder.append("\t\t");
    _builder.append("while (!parked) {");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("dly_tsk(100);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("if (color_left == COLOR_WHITE && color_right == COLOR_WHITE) //&& color_mid == COLOR_WHITE)");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("{\tparked = true;");
    _builder.newLine();
    _builder.append("\t");
    _builder.newLine();
    _builder.append("\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("else if (color_right == COLOR_WHITE){");
    _builder.newLine();
    _builder.append("\t\t\t\t");
    _builder.append("turn(false, 4);");
    _builder.newLine();
    _builder.append("\t\t\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public String getIndicationRocks() {
    String ret = "";
    EList<indication> _indicate = this.dr.getAfter_examinating().getIndicate();
    for (final indication indication : _indicate) {
      {
        InputOutput.<String>println(MarsRoverGenerator.indicationToText(indication.getType()));
        String _indicationToText = MarsRoverGenerator.indicationToText(indication.getType());
